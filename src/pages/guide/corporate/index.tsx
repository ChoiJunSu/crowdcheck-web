      ...
      <div className="mt-10 flex flex-col gap-10">
        <div className="rounded-md p-6 sm:p-10 bg-gray-100">
          ...
          <p className="mt-2 sm:text-xl text-gray-900">
            ...
            전화번호는 카카오톡 인증을 진행할 수 있는 번호를 입력해주세요.
          </p>
        </div>
        ...
        <div className="rounded-md p-6 sm:p-10 bg-gray-100">
          ...
          <p className="mt-2 sm:text-xl text-gray-900">
            의뢰 등록 메뉴에서 평판 조회 의뢰를 등록합니다. <br />
            지원자의 정보와 지원자에 대해 궁금하신 부분을 구체적으로
            작성해주세요. <br />
            이후의 평판 조회 동의와 평판 제공자 모집은 크라우드체크가
            진행합니다. <br />
        ...
        <div className="rounded-md p-6 sm:p-10 bg-gray-100">
          ...
          <p className="mt-2 sm:text-xl text-gray-900">
            내 의뢰 목록에서 각 의뢰의 상세보기 페이지로 이동하면 작성된 답변을
            보실 수 있습니다. <br />
            평판 제공자는 지원자와 경력이 겹치며, 지원자의 전화번호를 알고 있는
            개인 회원입니다. <br />
            해당 경력에 대해서는 크라우드체크가 검증을 진행합니다.
          </p>
        </div>
      </div>
    </div>
