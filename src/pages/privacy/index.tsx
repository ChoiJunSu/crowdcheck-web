  ...
  return (
    <div className="sm:max-w-4xl mx-auto p-2">
      ...
      <div>
        ...
        <br />
        <strong>제 2 조 (개인정보의 처리 및 보유 기간)</strong>
        <br />① 회사는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
        개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를
        처리·보유합니다. <br />② 각각의 개인정보 처리 및 보유 기간은 다음과
        같습니다.
        <ul>
          <li>1. 홈페이지 회원가입 및 관리</li>
          <li>
            홈페이지 회원가입 및 관리와 관련한 개인정보는 수집.이용에 관한
            동의일로부터 회원 탈퇴 시까지까지 위 이용목적을 위하여
            보유.이용됩니다.
          </li>
          <li>보유근거 : 「개인정보 보호법」 제15조 1항</li>
        </ul>
        <br />
        <strong>제 3 조 (개인정보의 제3자 제공)</strong>
        <br />① 회사는 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위
        ...
        <ul>
          <li>1. 지원자 평판 제공</li>
          <li>
            개인정보를 제공받는 자 : 개인 회원 본인의 이름과 전화번호로 평판
            조회 의뢰를 등록한 기업 회원
          </li>
          <li>제공받는 자의 개인정보 이용목적 : 평판 제공 및 지원자 식별</li>
          <li>
            제공하는 개인정보 항목 : 이름, 전화번호, 재직했던
            기업·부서명·입사일·퇴사일, 다른 개인 회원이 작성한 평판(업무능력,
            대인관계, 성격/인성, 이직사유 등)
          </li>
          <li>제공받는 자의 보유·이용기간: 해당 의뢰 종료시까지</li>
          <li>2. 지원자 정보 제공</li>
          <li>
            개인정보를 제공받는 자 : 개인 회원이 동의한 평판 조회 경력과 동일한
            기업에 지원자와 겹치는 기간 동안 재직하였다고 등록한 개인 회원
          </li>
          <li>
            제공받는 자의 개인정보 이용목적 : 평판 작성 요청 및 지원자 식별
          </li>
          <li>
            제공하는 개인정보 항목 : 이름, 전화번호, 함께 재직했던 기업·부서명
          </li>
          <li>제공받는 자의 보유·이용기간: 해당 의뢰 종료시까지</li>
        </ul>
        <br />
        <strong>제 4 조 (개인정보처리 위탁)</strong>
        <br />① 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보
        처리업무를 위탁하고 있습니다.
        <ul>
          <li>1. 클라우드 서버 운영 및 관리</li>
          <li>위탁받는 자 (수탁자) : Amazon Web Service Inc.(미국)</li>
          <li>위탁하는 업무의 내용 : 서비스 제공을 위한 서버 운영 및 관리</li>
          <li>위탁기간 : 회원 탈퇴시까지</li>
        </ul>
        ...
        등의 권리를 행사할 수 있습니다.
        <br />
        ② 제1항에 따른 권리 행사는회사에 대해 「개인정보 보호법」 시행령 제41조
        ...
        <br />
        <br />
        <strong>제 6 조 (처리하는 개인정보의 항목 작성) </strong>
        ...
        <ul>
          ...
          <li>
            선택항목 : 재직하였거나 재직 중인 기업·부서명·입사일·퇴사일,
            명함이나 경력증명서 등 재직을 증빙할 수 있는 자료(이상 개인 회원),
            사업자등록증(이상 기업 회원)
          </li>
        </ul>
        <br />
        ...
        <br />
        1. 파기절차 회사는 파기 사유가 발생한 개인정보를 선정하고, 회사 의
        개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
        <br />
        2. 파기방법 전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적
        방법을 사용합니다. 종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각을
        통하여 파기합니다
        <br />
        <br />
        <strong>제 8 조 (개인정보의 안전성 확보 조치)</strong>
        <br />
        ...
        <br />
        <br />
        <strong>제 10 조 (개인정보 보호책임자) </strong>
        <br />
        ...
        <ul>
          ...
          <li>직책 : 대표이사</li>
          <li>직급 : 대표이사</li>
          <li>전화번호 : 070-4283-0275</li>
          <li>이메일 : dev.crowdcheck@gmail.com</li>
        </ul>
        <br />
        <strong>제 11 조 (권익침해 구제방법)</strong>
        <br />
        ...
        <br />
        <br />
        <strong>제 12 조 (개인정보 처리방침 변경)</strong>
        <br />① 이 개인정보처리방침은 2022년 1월 1부터 적용됩니다. <br />②
