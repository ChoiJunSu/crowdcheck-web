...
import { IRequestReferenceRegisterFormData } from "@views/request/reference/register/RequestReferenceRegisterView/type";

const RequestReferenceRegisterView = () => {
...
export default RequestReferenceRegisterView;
