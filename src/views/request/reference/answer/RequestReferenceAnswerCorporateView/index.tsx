...
const RequestReferenceAnswerCorporateView = () => {
  ...
  useEffect(() => {
    (async () => {
      const referenceGetCorporateResponse =
        await RequestApi.referenceGetCorporate({
      ...
      setCandidateName(referenceGetCorporateResponse.candidateName);
      setQuestion(referenceGetCorporateResponse.question);
      setAnswerList(referenceGetCorporateResponse.answers);
    })();
  }, []);
...
export default RequestReferenceAnswerCorporateView;
