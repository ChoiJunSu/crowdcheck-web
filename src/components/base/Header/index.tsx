        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          {isLoggedIn && type ? (
            ...
            <div className="md:flex items-center justify-end md:flex-1 lg:w-0">
              ...
              <Link
                to="/auth/register"
                className="ml-4 md:ml-8 whitespace-nowrap inline-flex items-center justify-center px-2 md:px-4 py-1 md:py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-cc-green hover:bg-cc-green"
              >
                회원가입
              </Link>
            </div>
