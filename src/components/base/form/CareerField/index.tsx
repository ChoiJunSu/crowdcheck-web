          ...
          <div className="bg-white rounded-md shadow-sm grid grid-cols-4 sm:grid-cols-7 grid-flow-row-dense rounded-md border border-gray-300">
            <div className="col-span-3 flex-1 min-w-0 flex justify-between border-b border-gray-300">
              ...
              <input
                ...
                className="flex-1 min-w-0 block w-full px-3 py-2 border-0 focus:ring-cc-green focus:border-cc-green sm:text-"
              />
            </div>
            <div className="col-span-3 flex-1 min-w-0 flex justify-between border-b border-gray-300">
              ...
              <input
                ...
                className="flex-1 min-w-0 block w-full px-3 py-2 border-0 focus:ring-cc-green focus:border-cc-green sm:text-sm"
              />
            </div>
